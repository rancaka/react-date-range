...
var PredefinedRanges = (function (_Component) {
  ...
  _createClass(PredefinedRanges, [{
    ...
    key: 'handleBlur',
    value: function handleBlur(key) {
      var _this = this;

      return function (e) {
        var date = (0, _moment2['default'])(e.target.value).format('DD MMM YYYY');

        if (Number(e.target.value) < 13 || e.target.value.length > 11 || e.target.value.length < 10 || date === 'Invalid date') {
          _this.setState({
            error: _defineProperty({}, key, true)
          });
          return _this.props.onSelect(_extends({}, _this.props.range));
        };

        _this.setState({
          error: _defineProperty({}, key, false)
        });

        _this.props.onSelect(_extends({}, _this.props.range, _defineProperty({}, key, (0, _utilsParseInputJs2['default'])(e.target.value, null, key === 'startDate' ? 'startOf' : 'endOf'))));
      };
    }
  }, {
    key: 'renderRangeList',
    ...
    value: function render() {
      ...
      var enableInputDate = _props2.enableInputDate;
      var styles = this.styles;
      ...
      return _react2['default'].createElement(
        ...
        enableInputDate && _react2['default'].createElement(
          'div',
          ...
          _react2['default'].createElement(
            ...
            _react2['default'].createElement('input', {
              ...
              id: 'from',
              type: 'text',
              defaultValue: (0, _moment2['default'])(this.props.range.startDate).format('DD MMM YYYY'),
              onBlur: this.handleBlur('startDate') }),
            this.state.error.startDate && _react2['default'].createElement(
              'div',
              { style: { color: '#eb5055', fontSize: '10px' } },
              'Invalid date. E.g. ',
              _react2['default'].createElement(
                'i',
                null,
          ...
          _react2['default'].createElement(
            ...
            _react2['default'].createElement('input', {
              ...
              id: 'to',
              type: 'text',
              defaultValue: (0, _moment2['default'])(this.props.range.endDate).format('DD MMM YYYY'),
              onBlur: this.handleBlur('endDate') }),
            this.state.error.endDate && _react2['default'].createElement(
              'div',
              { style: { color: '#eb5055', fontSize: '10px' } },
              'Invalid date. E.g. ',
              _react2['default'].createElement(
